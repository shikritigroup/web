// export const addToCart = (itemId, type, offerPrice, deliveryFee) => {
...
//         "myOrder",
//         JSON.stringify({
//           deliveryFee: myOrderObject.deliveryFee,
//           items: [
//             ...myOrderObject.items.filter((item) => item.id !== itemId),
//             {
//               id: itemId,
//               type,
...
//         ...myOrderObject?.items?.map((item) => item?.order)
//       );
...
//       } else {
//         if (
//           myOrderObject.items.filter((item) => item.id !== itemId)?.length > 0
//         ) {
//           localStorage.setItem(
//             "myOrder",
//             JSON.stringify({
