        ...
        <Box sx={{ display: "block" }}>
          <FormGroup>
            <FormControl sx={{ display: "block", paddingBottom: "15px" }}>
              <InputLabel htmlFor="name">{t("b2b.fullname")} *</InputLabel>
              <Input
                required
                id="name"
                value={fullName}
            ...
            <Box sx={{ textAlign: "left", paddingBottom: "15px" }}>
              {t("b2b.interest")} *
            </Box>
            <FormControl sx={{ display: "block" }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={interest.indexOf("Incense") > -1}
                    value="Incense"
                    onChange={(e) => handleInterest(e.target.value)}
                  />
                }
                label={t("menu.incenses")}
              />
              <FormControlLabel
                control={
                  <Checkbox
                    checked={interest.indexOf("Spice") > -1}
                    value="Spice"
                    onChange={(e) => handleInterest(e.target.value)}
                  />
                }
